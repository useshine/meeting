	...
	e.DtPicker = e.Class.extend({
		...
		_createHours: function(e) {
			...
			if(i.customData.h) a = i.customData.h;
				...
				for(var r = t._isBeginDay() ? i.beginHours : 8, s = t._isEndDay() ? i.endHours : 20; s >= r; r++) {
					var c = t._fill(r);
					a.push({
						text: c,
						value: c
		...
		_createMinutes: function(e) {
			...
			if(i.customData.i) a = i.customData.i;
				...
				for(var r = t._isBeginHours() ? i.beginMinutes : 0, s = t._isEndHours() ? i.endMinutes : 59; s >= r;) {
					var c = t._fill(r);
					a.push({
						text: c,
						value: c
